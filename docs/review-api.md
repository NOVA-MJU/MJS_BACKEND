...
- 좋아요는 게시판과 똑같이 토글됩니다. 리뷰 작성자에게 **인앱 알림**이 쌓이며 FCM 푸시는 별도입니다.
...
- **본인이 작성한 리뷰에도 좋아요를 누를 수 있습니다.** 이 경우 인앱 알림과 FCM 푸시는 발송되지 않습니다(자기 알림 제외).
- **인앱 알림 있음** — 리뷰 작성자에게 좋아요 알림이 쌓입니다. FCM 푸시는 별도입니다.
...
**Q. 좋아요 알림이 오나요?**
리뷰 작성자에게 인앱 알림이 쌓입니다. 현재 FCM 푸시 발송과는 분리되어 있습니다.

**Q. 내가 쓴 리뷰에 좋아요를 누를 수 있나요?**
가능합니다. `likeCount`에도 정상 반영되며, 본인 활동이므로 알림만 발송되지 않습니다.
