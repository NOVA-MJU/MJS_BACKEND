...
public class SearchRankingPolicy {
    ...
    public SearchQueryPlan plan(
        ...
        return new SearchQueryPlan(
                ...
                policyStore.snapshot().exactTitleMatchBoost(),
                policyStore.snapshot().compactTitleMatchBoost(),
                policyStore.snapshot().searchTokenMatchBoost(),
                policyStore.snapshot().typoFuzzyBoost(),
                policyStore.snapshot().categoryMatchBoost(),
