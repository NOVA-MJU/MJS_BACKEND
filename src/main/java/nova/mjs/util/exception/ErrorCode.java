...
public enum ErrorCode {
    ...
    // 신고(Report) 관련 에러 (RP)
    REPORT_REASON_DETAIL_REQUIRED(HttpStatus.BAD_REQUEST, "REPORT_REASON_DETAIL_REQUIRED", "[MJS] 구체적인 기타 사유를 입력해 주세요."),
    ...
    // 명지도 즐겨찾기(그룹) 관련 에러 (FV)
    FAVORITE_GROUP_NOT_FOUND(HttpStatus.NOT_FOUND, "FAVORITE_GROUP_NOT_FOUND", "[MJS] 요청한 즐겨찾기 그룹을 찾을 수 없습니다."),
    FAVORITE_GROUP_FORBIDDEN(HttpStatus.FORBIDDEN, "FAVORITE_GROUP_FORBIDDEN", "[MJS] 해당 즐겨찾기 그룹에 접근할 권한이 없습니다."),
    FAVORITE_GROUP_NAME_INVALID(HttpStatus.BAD_REQUEST, "FAVORITE_GROUP_NAME_INVALID", "[MJS] 올바른 형식의 그룹명을 입력해 주세요. (1~12자)"),
    FAVORITE_GROUP_SYSTEM_MODIFY_NOT_ALLOWED(HttpStatus.BAD_REQUEST, "FAVORITE_GROUP_SYSTEM_MODIFY_NOT_ALLOWED", "[MJS] 시스템 기본 그룹은 수정하거나 삭제할 수 없습니다."),
    FAVORITE_MEMO_TOO_LONG(HttpStatus.BAD_REQUEST, "FAVORITE_MEMO_TOO_LONG", "[MJS] 메모는 최대 30자까지 입력할 수 있습니다.");
