...
@Slf4j
@Transactional
public class WeatherCommandServiceImpl implements WeatherCommandService {
    ...
    public WeatherCommandServiceImpl(@Qualifier("openWeatherMapClient") WebClient webClient, WeatherRepository weatherRepository) {
